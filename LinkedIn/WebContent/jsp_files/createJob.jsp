						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
								    ...
								    <input type="email" class="form-control" id="jobTitle" name="jobTitle" placeholder="Τίτλος Αγγελίας" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
								    <label class="sr-only" for="jobIndustry">Εταιρεία</label>
								    <input type="text" class="form-control" id="jobIndustry" name="jobIndustry" placeholder="Εταιρεία" required>
								</div>
							</div>
							<div class="col-md-4">
								<div class="form-group">
								    <label class="sr-only" for="jobLocation">Τοποθεσία</label>
								    <input type="text" class="form-control" id="jobLocation" name="jobLocation" placeholder="Τοποθεσία" required>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" name="jobDescription" id="jobDescription" required></textarea>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
								    ...
								    <textarea class="form-control" rows="2" name="skills" id="skills" placeholder="Δεξιότητες..." required></textarea>
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">	
									...
									<input type="number" class="form-control" id="fromYears" name="fromYears" value="0" required>
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">	
									<label for="toYears">Μέχρι*</label>
									<input type="number" class="form-control" id="toYears" name="toYears" value="3" required>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									...
									<input type="number" class="form-control" id="dailyMoney" name="dailyMoney" value="7" required>
								</div>
							</div>
						</div>
					</div>
